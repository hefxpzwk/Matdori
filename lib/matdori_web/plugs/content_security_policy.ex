  ...
  def call(conn, _opts) do
    policy =
      "default-src 'self'; " <>
        ...
        "img-src 'self' data: https://*.twimg.com https://platform.twitter.com https://pbs.twimg.com https://abs.twimg.com https://syndication.twitter.com https://ton.twimg.com; " <>
